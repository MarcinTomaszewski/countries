...
// ZADANIE 2
// 1. Z Tablicy Państw z zadania 1 przefiltruj wszystkie należące do
//  Unii Europejskiej.
// 2. Z uzyskanej w ten sposób tablicy usuń wszystkie
// państwa posiadające w swojej nazwie literę a.
// 3. Z uzyskanej w ten sposób tablicy posortuj państwa według populacji,
// tak by najgęściej zaludnione znajdowały się na górze listy.

// Zsumuj populację pięciu najgęściej zaludnionych państw i oblicz,
// czy jest większa od 500 milionów
